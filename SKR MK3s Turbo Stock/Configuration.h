...
#define STRING_CONFIG_H_AUTHOR "(Chris Warkocki, SKR V1.4 TURBO Pinda/TMC2209)" // Who made the changes.
...
// If you are going to use a firmware newer than 2.0.3 change board to BOARD_BTT_SKR_V1_4
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BIGTREE_SKR_V1_4_TURBO
#endif

// Name displayed in the LCD "Ready" message and Info menu
#define CUSTOM_MACHINE_NAME "SKR MK3s TURBO"
...
//Change eSteps to 830 for BMG with 1.8 degree or 1660 with 0.9 degree, 814 for Hemera
